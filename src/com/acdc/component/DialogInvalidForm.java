...
public class DialogInvalidForm extends JDialog implements ActionListener
{
	private final JTextField jtxfInput = new JTextField(32);
	private JComboBox jComboBoxCategories;
	private List<String> errors;
	
	public DialogInvalidForm(EkitCore peKit, String title, boolean bModal, List<String> errors)
	{		
	...
	public void init()
	{
	  	...
	  	for (String error : errors) {
			centerPanel.add(new JLabel(error, SwingConstants.LEFT));
		}
