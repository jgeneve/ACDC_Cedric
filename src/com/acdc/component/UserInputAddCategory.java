...
public class UserInputAddCategory extends JDialog implements ActionListener
{
//	private EkitCore parentEkit;
	...
	public UserInputAddCategory(EkitCore peKit, String title, boolean bModal, JComboBox jComboBoxCategories)
	{		
...
//		parentEkit = peKit;
   	...
   	public void actionPerformed(ActionEvent e)
   	{
		if(e.getActionCommand().equals("accept"))
		{
			...
			if (!inputText.isEmpty()) {
				boolean valid = Categories.addCategory(inputText);
				if (valid) {
					jComboBoxCategories.addItem(inputText.toLowerCase());
				}
			}
			setVisible(false);
		}	
	...
	public void init()
	{
	  	...
	  	JLabel categoryLabel = new JLabel("Nom de la catégorie :", SwingConstants.LEFT);
